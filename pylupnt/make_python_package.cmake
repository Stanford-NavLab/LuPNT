...
file(MAKE_DIRECTORY ${PYTHON_PACKAGE_DST_DIR}/pylupnt)
...
file(COPY ${PYTHON_COMPILED_MODULE_PATH}
     DESTINATION ${PYTHON_PACKAGE_DST_DIR}/pylupnt)
...
configure_file("${PYTHON_PACKAGE_SRC_DIR}/pylupnt/__init__.py"
               "${PYTHON_PACKAGE_DST_DIR}/pylupnt/__init__.py")
