...
import numpy
import numpy as np
__all__ = ['arr_to_mat_idx', 'cross_norm', 'i_to_arr_idxs', 'mat_to_arr_idx', 'np', 'wrap2Pi']
...
def mat_to_arr_idx(i: int, j: int, n: int) -> int:
    ...
    """
def wrap2Pi(x: typing.Union[float, numpy.ndarray]) -> typing.Union[float, numpy.ndarray]:
    """
