...
def decibel_to_decimal(x: numpy.ndarray[numpy.float64[m, 1]]) -> numpy.ndarray[numpy.float64[m, 1]]: ...
def decible_to_decimal(x: float) -> float: ...
@overload
def decimal_to_decibel(x: float) -> float: ...
@overload
def decimal_to_decibel(x: numpy.ndarray[numpy.float64[m, 1]]) -> numpy.ndarray[numpy.float64[m, 1]]: ...
