...
class Antenna:
    ...
    @overload
    def compute_gain(self, azim: float, elev: float) -> float: ...
    @overload
    def compute_gain(self, azim: numpy.ndarray[numpy.float64[m, 1]], elev: float) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    @overload
    def compute_gain(self, azim: float, elev: numpy.ndarray[numpy.float64[m, 1]]) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    @overload
    def compute_gain(self, azim: numpy.ndarray[numpy.float64[m, 1]], elev: numpy.ndarray[numpy.float64[m, 1]]) -> numpy.ndarray[numpy.float64[m, 1]]: ...
