...
class IDynamics:
    def __init__(self) -> None: ...
    def propagate(self, x0: numpy.ndarray[numpy.float64[m, 1]], t0: float, tf: float, stm: numpy.ndarray[numpy.float64[m, n]] = ...) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def propagate_state(self, *args, **kwargs): ...

class IOrbitDynamics(IDynamics):
    def __init__(self) -> None: ...
    @overload
    def propagate(self, x0: numpy.ndarray[numpy.float64[6, 1]], t0: float, tf: float, stm: numpy.ndarray[numpy.float64[6, 6]] = ...) -> numpy.ndarray[numpy.float64[6, 1]]: ...
    @overload
    def propagate(self, x0: numpy.ndarray[numpy.float64[1, 6]], t0: float, tf: float, stm: numpy.ndarray[numpy.float64[6, 6]] = ...) -> numpy.ndarray[numpy.float64[6, 1]]: ...
    @overload
    ...
    @overload
    def propagate(self, x0: numpy.ndarray[numpy.float64[6, 1]], t0: float, tf: numpy.ndarray[numpy.float64[m, 1]], stm: numpy.ndarray[numpy.float64[6, 6]] = ...) -> numpy.ndarray[numpy.float64[m, 6]]: ...
    def propagate_state(self, state: OrbitState, t0: float, tf: float, stm: numpy.ndarray[numpy.float64[6, 6]] = ...) -> OrbitState: ...
...
@overload
def convert_time(t: float, _from: str, to: str) -> float: ...
@overload
def convert_time(t: numpy.ndarray[numpy.float64[m, 1]], _from: str, to: str) -> numpy.ndarray[numpy.float64[m, 1]]: ...
@overload
