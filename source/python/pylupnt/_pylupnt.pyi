...
class CartesianTwoBodyDynamics(NumericalOrbitDynamics):
    ...
    @overload
    def propagate(self, x0: numpy.ndarray[numpy.float64[6, 1]], t0: float, tf: numpy.ndarray[numpy.float64[m, 1]]) -> numpy.ndarray[numpy.float64[m, 6]]: ...
    @overload
    def propagate(self, x0: numpy.ndarray[numpy.float64[1, 6]], t0: float, tf: numpy.ndarray[numpy.float64[m, 1]]) -> numpy.ndarray[numpy.float64[m, 6]]: ...
