...
class AnalyticalDynamics:
    ...
    def create_orbit_state(self, arg0) -> OrbitState: ...
...
class ClassicalOE(OrbitState):
    ...
    i: float
    w: float
    def __init__(self, [a,e,i,Omega,w,M]: numpy.ndarray[numpy.float64[6, 1]], frame: Frame = ..., deg: bool = ...) -> None: ...
...
class KeplerianDynamics(AnalyticalDynamics):
...
class OrbitState:
    ...
    def __init__(self, vector: numpy.ndarray[numpy.float64[6, 1]], frame: Frame, state_repres: OrbitStateRepres, names: list[str], units: list[str]) -> None: ...
    @property
