...
class KeplerianDynamics(IAnalyticalOrbitDynamics):
    ...
    @overload
    def propagate(self, x0: numpy.ndarray[numpy.float64[6, 1]], t0: float, tf: float) -> numpy.ndarray[numpy.float64[6, 1]]: ...
    @overload
    def propagate(self, x0: numpy.ndarray[numpy.float64[6, 1]], t0: float, tf: float, stm: numpy.ndarray[numpy.float64[6, 6], flags.writeable, flags.f_contiguous]) -> numpy.ndarray[numpy.float64[6, 1]]: ...
