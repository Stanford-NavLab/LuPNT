...
class Antenna:
    ...
    @overload
    def compute_gain(self, elev: float, azim: float) -> float: ...
    @overload
    def compute_gain(self, elev: numpy.ndarray[numpy.float64[m, 1]], azim: numpy.ndarray[numpy.float64[m, 1]]) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def get_azimuth_angles(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def get_elevation_angles(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def get_gain_pattern(self) -> numpy.ndarray[numpy.float64[m, n]]: ...
