...
namespace lupnt {
  ...
  public:
     ...
     */
    static Real ComputeOneWayRangeLTR(Real epoch_rx, Vec6 rv_tx, Vec6 rv_rx, Real dt_tx, Real dt_rx,
     ...
     * @return Real      One-way pseudorange at t_R (clock offset error included)
     */
    static Real ComputeTwoWayRangeLTR(Real epoch_rx, Vec6 rv_target_tr, Vec6 rv_rx_tr,
                                      Body *target_center_body, Body *rx_center_body,
                                      bool is_bodyfixed_target, bool is_bodyfixed_rx,
                                      Real hardware_delay, Real additional_delay = 0.0);
     ...
     * @return Real
     */
    static Real ComputeOneWayRangeRateLTR(Real epoch_rx, Vec6 rv_tx_tr, Vec6 rv_rx_tr,
                                          Real dt_dot_tx, Real dt_dot_rx, Body *target_center_body,
                                          Body *rx_center_body, bool is_bodyfixed_target,
                                          bool is_bodyfixed_rx, Real hardware_delay, double T_I);

    static Real ComputeTwoWayRangeRateLTR(Real epoch_rx, Vec6 rv_target_tr, Vec6 rv_rx_tr,
                                          Body *target_center_body, Body *rx_center_body,
                                          bool is_bodyfixed_target, bool is_bodyfixed_rx,
     ...
     */
    static double ComputePnRangeErrorCTL(double PRC_N0, double B_L_CTL, double T_c,
     ...
     */
    static double ComputeRangeRateErrorOneWay(double B_L_carrier, double f_C, double T_s,
     ...
     * @return double  range rate error [m/s]
     */
    static double ComputeRangeRateErrorTwoWay(double B_L_carrier, double f_C, double T_s,
                                              double T_I, double PT_N0, double sigma_y_1s, double G,
                                              CarrierType carrier_type = CarrierType::BPSK,
                                              double m_R = 0.0);
     ...
     */
    static double GetTransponderTurnAroundRatio(FrequencyBand fbu, FrequencyBand fbd);
     ...
     *
     */
    static double ComputeCarrierLoopSNR(double PT_N0, double B_L_carrier, double T_s,
