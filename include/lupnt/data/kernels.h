...
namespace lupnt {
  ...
  Vec6 GetBodyPosVel(Real t_tai, NaifId target, Frame frame = Frame::GCRF);
  Vec6 GetBodyPosVel(Real t_tai, NaifId center, NaifId target, Frame frame = Frame::GCRF);
  MatX6 GetBodyPosVel(const VecX& t_tai, NaifId target, Frame frame = Frame::GCRF);
  MatX6 GetBodyPosVel(const VecX& t_tai, NaifId center, NaifId target, Frame frame = Frame::GCRF);
}  // namespace lupnt
