...
void printOccultation(Vector6 state_tx_vec, Vector6 state_rx_vec,
  ...
  tmp_ad = CoordConverter::Convert(t, state_tx_vec, Frame::GCRF, Frame::MI);
  segment_mi = tmp_ad.segment(0, 3).cast<double>();
  tmp_ad = CoordConverter::Convert(t, state_tx_vec, Frame::GCRF, Frame::GCRF);
  segment_eci = tmp_ad.segment(0, 3).cast<double>();
  tmp_ad = CoordConverter::Convert(t, state_rx_vec, Frame::MI, Frame::GCRF);
