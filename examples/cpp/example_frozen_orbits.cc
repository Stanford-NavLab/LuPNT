...
int main() {
  ...
  auto coe_m_1_ = DelaunayToClassical(deloe_m_1, GM_MOON);
  auto coe_m_2_ = DelaunayToClassical(deloe_m_2, GM_MOON);
  ...
  auto coe_c_1 = MeanToOsculating(coe_m_1, GM_MOON, J2_MOON);
  auto coe_c_2 = MeanToOsculating(coe_m_2, GM_MOON, J2_MOON);
  return 0;
}