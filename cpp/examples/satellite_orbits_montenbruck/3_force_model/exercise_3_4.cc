// Montenbruck Exercise 3-4: set up a high-fidelity Earth-orbit force model with
// gravity, third bodies, drag, and SRP.
...
int main() {
  ...
  Vec6 rv0 = ClassicalToCart(coe0, GM_EARTH);   // [km, km/s]
  ...
  Body earth = Body::Earth(n_max, m_max);
  ...
  dyn.SetDragCoefficient(CD, area, mass);
