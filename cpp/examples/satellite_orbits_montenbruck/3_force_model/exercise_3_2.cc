// Montenbruck Exercise 3-2: compare low-precision lunar ephemerides with a
// SPICE/DE ephemeris query.
...
int main() {
  ...
  for (int i = 0; i <= N_step; i++) {
    ...
    r = GetBodyPosVel(t_tai, BodyId::EARTH, BodyId::MOON, Frame::GCRF).head(3);
