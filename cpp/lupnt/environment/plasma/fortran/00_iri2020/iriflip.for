...
C..... The EUVAC model is used for solar EUV irradiances
     ...
     >   ,OTHPR2(6)
      ...
      CALL RATS_2020(0,TE,TI,TN,RTS)  !.. Get the reaction rates

      !.. PRIMPR calculates solar EUV production rates.
      CALL
     &PRIMPR_2020(1,ALT,OXN,N2N,O2N,HEN,SZAD*0.01745,TN,F107,F107A,N4S)

      !.. Calculate secondary Production from photoelectrons
      CALL SECIPRD_2020(ALT,SZAD,F107,F107A,TE,TN,OXN,O2N,N2N,
     >   NE,N2APRD)
     ...
     >   +PEPION(3,4)+PEPION(3,5)+PEPION(3,6)
      ...
      CALL COP2P_2020(JPRINT,7,K,ALT,RTS,OXN,O2N,N2N,NE,OP2P,TPROD3,PSEC
     >    ,HEPLUS,N4S,NNO,TE)

      !.. O+(2D) Calculate and print densities, production, loss
      PSEC=PEPION(1,2)           !.. Photoelectron production
      TPROD2=EUVION(1,2)         !.. EUV
      CALL COP2D_2020(JPRINT,8,K,ALT,RTS,OXN,O2N,N2N,NE,OP2D,TPROD2,OP2P
     >    ,HEPLUS,N4S,NNO,PSEC)
      ...
      CALL
     &COP4S_2020(JPRINT,4,K,ALT,RTS,OXN,O2N,N2N,NE,COXPLUS,TPROD1,OP2D
     >    ,OP2P,PEPION(1,1),PDISOP,N2PLUS,N2D,NNO,1.0,HEPLUS)
      ...
      CALL CN2A_2020(JPRINT,27,K,ALT,RTS,OXN,O2N,N2N,NE,N2A,N2APRD,0.0,
     >     0.0,0.0)
      ...
      DO ITERS=1,5
        ...
        CALL
     &CN2PLS_2020(JPRINT,9,K,ALT,RTS,OXN,O2N,N2N,NE,N2PLUS,EUVION(3,1)
     ...
     >   ,OP2D,OP2P,HEPLUS,NPLUS,NNO,N4S)
        ...
        CALL
     &CN2D_2020(JPRINT,16,K,ALT,RTS,OXN,O2N,N2N,NOPLUS,NE,PN2D,LN2D
     >    ,N2PLUS,DISN2D,UVDISN,NPLUS,N2P,N2D,OXPLUS,NNO,N2A)
        ...
        CALL CNPLS_2020(JPRINT,10,K,ALT,RTS,OXN,O2N,N2N,NE,DISNP,NPLUS,
     >    OXPLUS,N2D,OP2P,HEPLUS,PHOTN,O2PLUS,N4S,OP2D,N2PLUS,NNO)

        !.. NO Calculate and print densities, production, loss.
        CALL CNO_2020(JPRINT,15,K,ALT,RTS,OXN,O2N,N2N,NE,PNO,LNO
     >    ,N2D,N4S,N2P,NNO,O2PLUS,OXPLUS,OTHPR2(2),OTHPR2(1),N2A,NPLUS)
        ...
        !.. NO+ Calculate and print densities, production, loss.
        CALL
     &CNOP_2020(JPRINT,11,K,ALT,RTS,OXN,O2N,N2N,NE,TPNOP,NOPLUS,OXPLUS
     ...
     >       PEPION(2,2)+PEPION(2,3)
        CALL CO2P_2020(JPRINT,12,K,ALT,RTS,OXN,O2N,N2N,NE,O2PPROD
...
C..... First N(2D)
      SUBROUTINE CN2D_2020(JPR,I,JPT,Z,RTS,ON,O2N,N2N,NOP,NE,P1,L1
...
C...      EF=RTS(61)*0.76/L1
 ...
 7    FORMAT(F6.1,1P,22E8.1)
      END
C:::::::::::::::::::::::::::::: NO ::::::::::::::::::::::::::::::::::::::::
      SUBROUTINE CNO_2020(JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,P1,L1
 ...
 7    FORMAT(F6.1,1P,22E9.2)
      END
C::::::::::::::::::::::::::::::: N(4S):::::::::::::::::::::::::::::::::::::::
      SUBROUTINE CN4S_2020(
     &JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,P1,L1,N4S,DISN4S
...
C..... in the (X,A,B states). PEN2P* same for p.e.s (X,A,B states)
      SUBROUTINE CN2PLS_2020(JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,N2PLS,PUN2PX,
 ...
 7    FORMAT(F6.1,1P,22E8.1)
      END
C:::::::::::::::::::::::::::::: NO+ ::::::::::::::::::::::::::::::::::
      SUBROUTINE CNOP_2020(JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,P1,NOP,OPLS
 ...
 7    FORMAT(F6.1,1P,22E9.2)
      END
C::::::::::::::::::::::::::::::: O2+ :::::::::::::::::::::::::::::::::::::::
      SUBROUTINE CO2P_2020(JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,P1
 ...
 7    FORMAT(F6.1,1P,22E9.2)
      END
C::::::::::::::::::::::::::::::::: O+(4S) :::::::::::::::::::::::::::::::::::::
      SUBROUTINE COP4S_2020(
     &JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,OPLS,TPROD1,OP2D
 ...
 7    FORMAT(F6.1,1P,22E8.1)
      END
C::::::::::::::::::::::::::::::::::: O+(2D) :::::::::::::::::::::::::::::::::::
      SUBROUTINE COP2D_2020(
     &JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,OP2D,TPROD2,OP2P
     > ,HEPLUS,N4S,NNO,PSEC)
      IMPLICIT REAL (A-H,L,N-Z)
      DIMENSION RTS(99),LR(22),PR(22)
 ...
 7    FORMAT(F6.1,1P,22E9.2)
      END
C::::::::::::::::::::::::::::::::::: O+(2P) :::::::::::::::::::::::::::::::::::
      SUBROUTINE COP2P_2020(
     &JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,OP2P,TPROD3,PSEC
     > ,HEPLUS,N4S,NNO,TE)
      IMPLICIT REAL(A-H,L,N-Z)
      DIMENSION RTS(99),LR(22),PR(22)
      PR(1)=0.0
 ...
 7    FORMAT(F6.1,1P,22E9.2)
      END
C:::::::::::::::::::::::::::::::::: N+ ::::::::::::::::::::::::::::::::::::
      SUBROUTINE CNPLS_2020(JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,DISNP
 ...
 7    FORMAT(F6.1,1P,22E9.2)
      END
C::::::::::::::::::::::::::::::::: N2(A3sigma+LBH) :::::::::::::::::::::::::::::::::::::
      SUBROUTINE CN2A_2020(JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE
...
C..... 21-AUG-1992. Added N2+ recombination source
      SUBROUTINE CN2P_2020(JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,P1,L1
...
C...... Written by P. Richards in February 2004
      SUBROUTINE CNOPV_2020(JPR,I,JPT,Z,RTS,ON,O2N,N2N,NE,P1,NOP,OPLS
     >  ,N2PLS,O2P,N4S,NNO,NPLUS,N2P,PLYNOP,VCON,N2D,OP2D)
      IMPLICIT NONE
...
C.... 2001, page 21,305. Rates different from Fox and Sung indicated by PGR
      SUBROUTINE RATS_2020(J,TE,TI,TN,RTS)
      IMPLICIT REAL(A-H,L,N-Z)
...
C..... Calculate secondary ion production, electron heating rate and 3371 excitation rate.
      SUBROUTINE SECIPRD_2020(
     &ALT,SZADEG,F107,F107A,TE,TN,OXN,O2N,N2N,XNE,
     >   N2APRD)
     ...
     >             ,.00, 0.0,0.0,0.02/
      ...
      !.. Go and get the photoelectron fluxes
       XN2D=0
       XOP2D=0
       CALL FLXCAL_2020(IDIM,ALT,SZADEG,
     >   TE,TN,XN,XNE,XN2D,XOP2D,PEFLUX,AFAC,IMAX,DE,EV)
      ...
      DO I=1,IMAX
        E=EV(I)
        CALL TXSION_2020(E,SIGIT)                     !.. total ion XS
        CALL SIGEXS_2020(E,TE,XNE,SIGOX,SIGN2,SIGEE)
        CALL OXSIGS_2020(E,SIGEX,SIGOX)
        ...
        CALL OXRAT_2020(E,SPRD(1,1),SPRD(1,2),SPRD(1,3))
...
C------ AFAC = the solar EUV attenuation warning flag
      SUBROUTINE FLXCAL_2020(IDIM,ALT,SZADEG,
     >  TE,TN,XN,XNE,XN2D,XOP2D,PEFLUX,AFAC,IMAX,DE,EV)
      INTEGER RDIM,IMAX
...
c      COMMON/SOL/UVFAC(59),EUV
     ...
     >  465,475,485,495/
      ...
      CALL SCOLUM_2020(I,SZA,ALT*1.0E5,TN,XN,COLUM)
      ...
      DO 133 IE=1,IMAX
        ...
        XSOXT=T_XS_OX_2020(EP)         !.. New OX cross section
        XSO2T=2.2*T_XS_OX_2020(EP)     !.. O2 XS is 2.2* O XS
        XSN2T=T_XS_N2_2020(EP)         !.. New N2 cross section
        ...
        !..... cascade production from thermal electron DEG2RADation
        CASEL=0.0
        ...
        CALL SIGEXS_2020(EE,TE,XNE,SIGOX,SIGN2,SIGEE)


        CALL FACFLX_2020(EE,UVFAC,FFAC)
 ...
 55   RETURN
      END
C::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      SUBROUTINE FACFLX_2020(EE,UVFAC,FFAC)
...
C....... TORR et al.[1979] GRL page 771 table 3. UVFAC(9) is for 304A
      ...
      END
C::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      SUBROUTINE SIGEXS_2020(E,TE,XNE,SIGOX,SIGN2,SIGEE)
...
C..... with the Schram et al. cross sections at high energies
      SUBROUTINE TXSION_2020(E,SIGIT)
      DIMENSION SIGIT(3)
      ...
      END
C:::::::::::::::::::::::::::::::::::: OXRAT ::::::::::::::::::::::::::::::::
      SUBROUTINE OXRAT_2020(E,R4S,R2D,R2P)
...
C.... cross section. P. Richards 2003-10-04
      ...
      IF(EP.GE.600.0) THEN
        t_xs_n2_2020=0.5E-18
      !.. Wavelength < 31 A, Auger ionization
      ELSEIF(EP.GE.400.0) THEN
        t_xs_n2_2020=1.0E-18
      !.. Wavelength 31.62 to 23.70 A
      ELSEIF(EP.GE.392.0) THEN
        t_xs_n2_2020=EXP(7.9864*ALOG(EP)-91.6604)
      !.. Wavelength 225 to 125 A
      ELSEIF(EP.GE.55.09) THEN
        t_xs_n2_2020=EXP(-2.3711*ALOG(EP)-29.8142)
      !.. Wavelength > 225 A
      ELSE
        t_xs_n2_2020=EXP(-1.1077*ALOG(EP)-34.8787)
      ENDIF
      ...
      !..t_xs_n2_2020=3.39E-17*EXP(-0.0263*EP)
...
C.... Samson and Pareek Phys. Rev. A, 31, 1470, 1985
      ...
      IF(EP.GE.500.0) THEN
        ...
        t_xs_ox_2020=0.5E-18
      ELSEIF(EP.GE.165.26) THEN
        !.. Wavelength shorter than 75 A
        t_xs_ox_2020=EXP(-2.5209*ALOG(EP)-28.8855)
      ELSEIF(EP.GE.55.09) THEN
        !.. Wavelength between 78 and 256.26 A
        t_xs_ox_2020=EXP(-1.7871*ALOG(EP)-32.6335)
      ELSE
        !.. Wavelength longer than 256.26 A
        t_xs_ox_2020=EXP(-1.3077*ALOG(EP)-34.5556)
      ENDIF
      ...
      !.. old parameterization
      !.. t_xs_ox_2020=27.2E-18*EXP(-3.09E-2*EP)
...
C
C:::::::::::::::::::::: OXSIGS :::::::::::::::::::::::::::::::::::::
      SUBROUTINE OXSIGS_2020(E,SIGEX,SIGEXT)
...
C.... 2009 for the chemical equilibrium model by P. richards.
      SUBROUTINE PRIMPR_2020(IJ,Z,ZOX,ZN2,ZO2,HE,SZA,TN,F107,F107A,N4S)
      IMPLICIT NONE
...
cpgr
     ...
     > TPOT(3,10),NNI(3),LAMAX
      ...
      IF(ABS((F107-F107SV)/F107).GT.0.005) THEN
        ...
        CALL FACEUV_2020(UVFAC,F107,F107A)
        CALL FACSR_2020(UVFAC,F107,F107A)

        !.. call params_2020 to get solar flux data and cross sections
        CALL PARAMS_2020(0,LMAX)
        F107SV=F107
      ENDIF

      !..  find probability for formation of each state  ........
      IF(IPROBS.EQ.0) THEN
        CALL PROBS_2020(0,PROB,ZLAM,LMAX,NNI)
        DO I=1,3
        DO K=1,6
        DO L=1,37
...
C...... get column densities for scattered light at night  &&&&&&&&
      CALL SCOLUM_2020(IJ,0.0E0,ZZ,TNJ,XN,CLNITE)
C
C...... evaluate the neutral column density  &&&&&&&&
      CALL SCOLUM_2020(IJ,CHI,ZZ,TNJ,XN,COLUMN)
...
C........ OTHPR1(3)= dissociation rate. OTHPR1(5)= Energy
      CALL SCHUMN_2020(IJ,Z,ZO2,COLUMN,OTHPR1(3),OTHPR1(5))
C
...
C.... the MSIS model at grazing incidence
      SUBROUTINE SCOLUM_2020(J,CHI,Z,TN,XN,COLUMN)
      IMPLICIT NONE
      INTEGER I,J
 ...
 10   CONTINUE
      ...
      END
C:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      SUBROUTINE PARAMS_2020(ISW,LMAX)
...
C
 ...
 91   FORMAT(22F5.1)
      END
C:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      SUBROUTINE PROBS_2020(ISW,PROB,ZLAM,LMAX,NNI)
...
C....... call separate subroutines for o2 and n2 probabilities
      DO 30 L=1,LMAX
      CALL PROBO2_2020(1,L,ZLAM(L),PROB,NNI(2))
      CALL PROBN2_2020(1,L,ZLAM(L),PROB,NNI(3))
 30   CONTINUE
C
      IF(ISW.EQ.0) RETURN
      WRITE(17,95)
 ...
 90   FORMAT(F8.2,22F5.2)
      ...
      END
C::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
         SUBROUTINE PROBN2_2020(ISW,L,ZLAM,PROB,JPTS)
...
C....... normalise probabilities
 ...
 50   PROB(3,J,L)=PROB(3,J,L)/SUM
      ...
      END
C:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
         SUBROUTINE YLDISS_2020(ISW,ZLAM,YIELD)
...
C...... parabolic interpolation see formula page 66 kirby et al
 ...
 30   RETURN
      END
C:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
         SUBROUTINE PROBO2_2020(ISW,L,ZLAM,PROB,JPTS)
...
C
      ...
      END
C:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      SUBROUTINE SCHUMN_2020(J,Z,ZO2,COLUMN,SCHUPR,SCHUHT)
...
C
 ...
 90   FORMAT(2X,I5,1P,9E9.1)
      ...
      END
C:::::::::::::::::::::::::::::::: FACEUV :::::::::::::::::::::::
      SUBROUTINE FACEUV_2020(UVFAC,F107,F107A)
...
C----- (F107+F107A)/2
 ...
 50      CONTINUE
      ...
      END
C::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      SUBROUTINE FACSR_2020(UVFAC,F107,F107A)
