...
void init_coord_converter(py::module &m) {
  ...
  py::class_<CoordConverter>(m, "CoordConverter")
      ...
      .def_static(
          "convert",
          [](double epoch, const Vector3d &r_in, Frame coord_sys_in,
             Frame coord_sys_out) -> Vector3d {
      ...
      .def_static(
          ...
          [](double epoch, const CartesianOrbitState &state_in,
             Frame coord_sys_out) -> CartesianOrbitState {
      ...
      .def_static(
          "convert",
          [](const VectorXd &epoch, const Vector6d &rv_in, Frame coord_sys_in,
             Frame coord_sys_out) -> MatrixXd {
            Vector6 rv_in_real = rv_in.cast<real>();
            return CoordConverter::Convert(epoch, rv_in_real, coord_sys_in,
                                           coord_sys_out)
                .cast<double>();
      ...
      .def_static(
          "convert",
          [](const VectorXd &epoch, const Vector3d &r_in, Frame coord_sys_in,
             Frame coord_sys_out) -> MatrixXd {
            Vector3 r_in_real = r_in.cast<real>();
            return CoordConverter::Convert(epoch, r_in_real, coord_sys_in,
                                           coord_sys_out)
      ...
      .def_static(
          "convert",
          [](double epoch, const Matrixd<-1, 6> &rv_in, Frame coord_sys_in,
             Frame coord_sys_out) -> Matrixd<-1, 6> {
      ...
      .def_static(
          "convert",
          [](double epoch, const Matrixd<-1, 3> &r_in, Frame coord_sys_in,
             Frame coord_sys_out) -> Matrixd<-1, 3> {
      ...
      .def_static(
          ...
          [](const VectorXd &epoch, const Matrixd<-1, 6> &rv_in,
             Frame coord_sys_in, Frame coord_sys_out) -> Matrixd<-1, 6> {
            return CoordConverter::Convert(epoch, rv_in.cast<real>().eval(),
                                           coord_sys_in, coord_sys_out)
                .cast<double>();
          },
      ...
      .def_static(
          ...
          [](const VectorXd &epoch, const Matrixd<-1, 3> &r_in,
             Frame coord_sys_in, Frame coord_sys_out) -> Matrixd<-1, 3> {
            return CoordConverter::Convert(epoch, r_in.cast<real>().eval(),
                                           coord_sys_in, coord_sys_out)
                .cast<double>();
          },
