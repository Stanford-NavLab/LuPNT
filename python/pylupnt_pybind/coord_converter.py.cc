  ...
  py::class_<CoordConverter>(m, "CoordConverter")
      ...
      .def_static(
          ...
          [](double epoch, const Vector6d &rv_in, Frame frame_in,
            ...
            return CoordConverter::Convert(epoch, rv_in_real, frame_in,
                                           frame_out)
                .cast<double>();
          },
      ...
      .def_static(
          ...
          [](double epoch, const Vector3d &r_in, Frame frame_in,
            ...
            return CoordConverter::Convert(epoch, r_in_real, frame_in,
                                           frame_out)
                .cast<double>();
          },
      ...
      .def_static(
          ...
          [](double epoch, const CartesianOrbitState &state_in,
            ...
            return CoordConverter::Convert(epoch, state_in, frame_out);
          },
