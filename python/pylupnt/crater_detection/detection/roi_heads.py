...
from ..common.conics import conic_matrix
from ..detection.metrics import (
    norm_mv_kullback_leibler_divergence,
    ...
    def forward(
        ...
        if targets is not None:
            for t in targets:
                ...
                assert (
                    t["ellipse_matrices"].dtype in floating_point_types
                ), "target ellipse_offsets must of float type"
                assert (
