...
implementation of the forward mode algorithm in {{lupnt}} uses *template
...
We appreciate your intention of citing {{lupnt}} in your publications. Please
use the following BibTeX reference entry:

~~~bibtex
@misc{lupnt,
    author = {Leal, Allan M. M.},
    title = {lupnt, a modern, fast and expressive {C++} library for automatic differentiation},
    url = {https://lupnt.github.io},
    howpublished = {\texttt{https://lupnt.github.io}},
    year = {2018}
}
~~~
...
> Leal, A.M.M. (2018). *lupnt, a modern, fast and expressive C++ library for automatic differentiation*.
> [https://lupnt.github.io](https://lupnt.github.io)
